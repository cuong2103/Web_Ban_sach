...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
    <div class="w-full">
        ...
        <form action="<?= BASE_URL ?>?act=admin-books-update" method="POST" enctype="multipart/form-data"
            class="grid grid-cols-1 xl:grid-cols-3 gap-6" id="edit-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tác giả <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="author" list="author_list"
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-4 space-y-3 border-t">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="status" value="1" <?= old('status', $book['status']) == '1' ? 'checked' : '' ?>
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_featured" value="1" <?= old('is_featured', $book['is_featured']) == '1' ? 'checked' : '' ?>
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_bestseller" value="1" <?= old('is_bestseller', $book['is_bestseller']) == '1' ? 'checked' : '' ?>
                    ...
                    <div>
                        <div
                            ...
                            <label for="thumbnail" id="thumbnail-upload-container"
                                class="w-full h-full cursor-pointer <?= $book['thumbnail'] ? 'hidden' : 'flex' ?> flex-col items-center justify-center p-6">
                            ...
                            <div id="thumbnail-preview"
                                class="<?= $book['thumbnail'] ? '' : 'hidden' ?> absolute inset-0 z-10 bg-white">
                                <img src="<?= $book['thumbnail'] ? htmlspecialchars(BASE_URL . $book['thumbnail']) : '' ?>"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div id="gallery-preview-container" class="grid grid-cols-3 gap-3">
                        ...
                        <?php foreach ($bookImages as $img): ?>
                            <div
                                class="w-full aspect-square relative rounded-lg border border-gray-200 overflow-hidden group">
                                <img src="<?= htmlspecialchars(BASE_URL . $img['image_url']) ?>"
                                    class="w-full h-full object-cover">
                                <div
                                    class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button type="button"
                                        class="bg-red-500 text-white p-1.5 rounded-full hover:bg-red-600 transition-colors remove-old-gallery-item"
                ...
                <button type="submit"
                    class="w-full py-3 bg-[#4CAF50] text-white rounded-xl hover:bg-green-600 transition-colors font-bold text-lg shadow-sm mt-4">
                    Lưu thay đổi
                </button>
            </div>
        </form>
