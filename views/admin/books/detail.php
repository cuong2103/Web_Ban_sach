...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
    <div class="w-full">
        ...
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
            ...
            <span class="font-medium text-gray-800">Chi tiết: <?= htmlspecialchars($book['title']) ?></span>
        </div>

        <div class="mb-8 flex items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Chi tiết sách</h2>
                <p class="text-xs text-gray-500 mt-1">Thông tin đầy đủ của sách trong hệ thống</p>
            </div>
