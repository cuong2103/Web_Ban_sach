...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
    <div class="w-full">
        ...
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500">
            ...
            <span class="font-medium text-gray-800">Thêm sách mới</span>
        </div>

        <div class="mb-8 flex items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Thêm sách mới</h2>
                <p class="text-gray-500 text-sm mt-1">Điền thông tin chi tiết để thêm sách vào hệ thống</p>
            </div>
        </div>

        <form action="<?= BASE_URL ?>?act=admin-books-store" method="POST" enctype="multipart/form-data"
            ...
            <div class="xl:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="publisher" list="publisher_list"
                                    value="<?= old('publisher') ?>"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20 focus:border-[#4CAF50] transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Giá gốc (VNĐ) <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tồn kho <span
                                    class="text-red-500">*</span></label>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Trọng lượng (Ví dụ:
                                300g)</label>
                            <input type="text" name="weight" value="<?= old('weight') ?>"
                                class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20 focus:border-[#4CAF50] transition-colors">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Kích thước (Ví dụ:
                                13x20cm)</label>
                        ...
                        <div>
                            ...
                            <select name="cover_type"
                                class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4CAF50]/20 focus:border-[#4CAF50] transition-colors">
                                <option value="Bìa mềm" <?= old('cover_type') == 'Bìa mềm' ? 'selected' : '' ?>>Bìa mềm
                                </option>
                                <option value="Bìa cứng" <?= old('cover_type') == 'Bìa cứng' ? 'selected' : '' ?>>Bìa cứng
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="pt-4 space-y-3 border-t">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_featured" value="1" <?= old('is_featured') == '1' ? 'checked' : '' ?> class="w-4 h-4 text-yellow-500 border-gray-300 rounded
                                focus:ring-yellow-500">
                                <span class="text-sm text-gray-700">Đánh dấu <b>Sách nổi bật</b></span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_bestseller" value="1" <?= old('is_bestseller') == '1' ? 'checked' : '' ?> class="w-4 h-4 text-blue-500 border-gray-300 rounded
                                focus:ring-blue-500">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div>
                        <div
                            class="mt-1 flex justify-center border-2 border-gray-300 border-dashed rounded-xl relative hover:bg-gray-50 transition-colors overflow-hidden aspect-square w-full max-w-[200px] mx-auto">
                            <label for="thumbnail" id="thumbnail-upload-container"
                                class="w-full h-full cursor-pointer flex flex-col items-center justify-center p-6">
                            ...
                            <div id="thumbnail-preview" class="hidden absolute inset-0 z-10 bg-white">
                                ...
                                <div
                                    ...
                                    <button type="button" id="thumbnail-remove"
                                        class="bg-red-500 text-white p-3 rounded-full hover:bg-red-600 transition-colors shadow-sm cursor-pointer z-20">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                    ...
                    <div id="gallery-preview-container" class="grid grid-cols-3 gap-2">
                        ...
                        <div class="w-full aspect-square border-2 border-dashed border-gray-200 rounded-lg flex items-center justify-center text-gray-400 text-xs text-center p-2"
                            id="gallery-empty">
                            Chưa có ảnh
                        </div>
                    </div>
                ...
                <button type="submit"
                    class="w-full py-3 bg-[#4CAF50] text-white rounded-xl hover:bg-green-600 transition-colors font-bold text-lg shadow-sm">
                    Thêm sách mới
                </button>
            </div>
        </form>
