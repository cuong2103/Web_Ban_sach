            ...
            <div class="p-4 border-b border-gray-100 bg-gray-50/50">
                <form action="" method="GET" class="flex flex-wrap gap-4 items-center justify-between w-full">
                    ...
                    <div class="flex flex-1 min-w-[300px] gap-4">
                        ...
                        <button type="submit"
                            class="px-6 py-2 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-colors font-medium">
                            Lọc
                        </button>

                        <?php if (!empty($_GET['search'])): ?>
                            <a href="<?= BASE_URL ?>?act=admin-inventories"
                                class="px-4 py-2 bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-xl transition-colors font-medium flex items-center gap-2">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50 border-b border-gray-100">
                            ...
                            <th class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Tác Giả
                            </th>
                            ...
                            <th class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Tồn Kho
                            </th>
                            <th
                                class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">
                                Nhập Kho</th>
                            <th class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Cập Nhật
                            </th>
                        </tr>
                    </thead>
                        ...
                        <?php else: ?>
                            <?php foreach ($inventories as $inventory): ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 max-w-[200px] truncate"
                                        title="<?= htmlspecialchars($inventory['title']) ?>">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <span class="px-2.5 py-1 bg-gray-100 text-gray-600 rounded-lg font-mono text-xs">
                                            <?= htmlspecialchars($inventory['category_name'] ?? 'N/A') ?>
                                        </span>
                                    </td>
            ...
            <?php if (!empty($totalPages) && $totalPages > 1): ?>
                <div
                    ...
                    <div class="text-sm text-gray-500">
                        Trang <span class="font-medium text-gray-900">
                            <?= $currentPage ?>
                        </span> /
                        <?= $totalPages ?>
                    </div>
                    ...
                    <div class="flex gap-1">
                        ...
                        <?php if ($currentPage > 1): ?>
                            <a href="<?= $baseUrl ?>&page=1"
                                class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-gray-600 hover:bg-gray-50 hidden sm:block">Đầu</a>
                            <a href="<?= $baseUrl ?>&page=<?= $currentPage - 1 ?>"
                                class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-gray-600 hover:bg-gray-50 flex items-center">
                        ...
                        <?php if ($currentPage < $totalPages): ?>
                            ...
                            <a href="<?= $baseUrl ?>&page=<?= $totalPages ?>"
                                class="px-3 py-1.5 border border-gray-200 rounded-lg bg-white text-gray-600 hover:bg-gray-50 hidden sm:block">Cuối</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
