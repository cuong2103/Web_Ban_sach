    ...
    <aside class="bg-white rounded-xl border border-gray-100 p-4 h-fit">
      ...
      <div class="space-y-3 mb-4 max-h-64 overflow-auto pr-1">
        ...
        <div class="flex items-start gap-3">
          <img src="<?= !empty($item['thumbnail']) ? (str_starts_with($item['thumbnail'], 'http') ? htmlspecialchars($item['thumbnail']) : rtrim(BASE_URL, '/') . '/' . ltrim($item['thumbnail'], '/')) : 'https://placehold.co/60x80?text=No+Image' ?>" onerror="this.onerror=null; this.src='https://placehold.co/60x80?text=No+Image';"
