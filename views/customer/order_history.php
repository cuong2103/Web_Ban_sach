                    ...
                    <tr class="border-t border-gray-100 text-sm hover:bg-gray-50/60 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="<?= BASE_URL ?>?act=order-detail&code=<?= urlencode($order['order_code']) ?>"
                                class="text-[#4CAF50] hover:text-[#43A047] font-medium block">Xem chi tiết</a>
                            <?php if (isset($order['status_id']) && (int)$order['status_id'] === 1): ?>
                            <a href="<?= BASE_URL ?>?act=order-cancel&code=<?= urlencode($order['order_code']) ?>"
                                class="text-red-500 hover:text-red-600 font-medium text-xs block mt-1"
