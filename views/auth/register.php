    ...
    <div class="flex items-center justify-center min-h-[calc(100vh-200px)]">
        <div class="w-full max-w-lg">
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Đăng ký thành viên</p>
            </div>

            <div class="bg-white rounded-2xl shadow-xl p-8">
                <h2 class="text-xl font-semibold text-gray-800 mb-6">Tạo tài khoản khách hàng</h2>
                ...
                <form action="<?= BASE_URL ?>?act=check-register" method="POST" class="space-y-4" novalidate>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <i data-lucide="lock" class="absolute left-3 top-2.5 w-5 h-5 text-gray-400"></i>
                            <input type="password" name="password_confirm" id="password_confirm" placeholder="Nhập lại mật khẩu"
                    ...
                    <div class="flex items-start gap-3 pt-2">
                        <input type="checkbox" id="terms" name="terms" required class="w-4 h-4 mt-0.5 rounded border-gray-300 text-[#4CAF50] focus:ring-[#4CAF50]">
                        <label for="terms" class="text-sm text-gray-600">
                            Tôi đồng ý với <a href="#" class="text-[#4CAF50] font-medium hover:underline">Điều khoản dịch vụ và Chính sách bảo mật</a>
                        </label>
                    </div>
                    ...
                    <button type="submit" class="w-full bg-[#4CAF50] hover:bg-[#43A047] text-white font-semibold py-2.5 rounded-lg transition duration-150 flex items-center justify-center gap-2 mt-6">
            ...
            <p class="text-center text-xs text-gray-400 mt-4">© <?= date('Y') ?> BookStore.</p>
        </div>
    </div>
</div>
