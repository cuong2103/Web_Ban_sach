    ...
    <div class="flex items-center justify-center min-h-[calc(100vh-200px)]">
        <div class="w-full max-w-lg">
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Đăng nhập khách hàng</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <?php if ($error): ?>
                <div id="login-error-alert" class="mb-4 px-4 py-3 bg-red-50 border border-red-300 text-red-700 rounded-lg text-sm flex items-center gap-2">
                ...
                <form action="<?= BASE_URL ?>?act=check-login" method="POST" class="space-y-5">
                    ...
                    <button type="submit" class="w-full bg-[#4CAF50] hover:bg-[#43A047] text-white font-semibold py-2.5 rounded-lg transition duration-150 flex items-center justify-center gap-2">
